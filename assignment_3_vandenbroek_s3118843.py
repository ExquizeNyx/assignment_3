...
# 1. This programm calculates the library size of a sample.
# 2. This programm filters and insert gene names and writes the results to a output file
...
#### filtering and inserting gene names ####
...
for read_data in readcounts:
    ...
    key = read_data[0]
    if key in report:
        gene_name = report[key]
        new_data.insert(1,gene_name[3])
